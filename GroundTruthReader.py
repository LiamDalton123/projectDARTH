...
class GroundTruthReader:
    ...
    def load_ground_truth_array(self, gt_filename, start_of_analysis_sec, end_of_analysis_sec):
        ...
        each of frame_duration_sec, and each result in the returned ground truth indicates if speech is present
    ...
    def calculate_ground_truth_array(self, speech_intervals, start_of_analysis_sec, end_of_analysis_sec):
        ...
        for interval in speech_intervals:
            ...
            if current_time_sec>start_of_analysis_sec:
                print("Ground truth array: " + str(gt_array[start_of_analysis_sec:]))
        ...
        print("Ground truth array: " +  str(gt_array[start_of_analysis_sec:end_of_analysis_sec]))
        return gt_array[start_of_analysis_sec:end_of_analysis_sec]



    def old_calculate_ground_truth_array(self, speech_intervals, start_of_analysis_sec, end_of_analysis_sec):
        gt_array = []
